...
import minecraft.planner.model.maze.PrimMazeModel;

public class PrimMazeProvider extends StructureProvider<MazeParameters> {
   private PrimMazeModel model = new PrimMazeModel();
