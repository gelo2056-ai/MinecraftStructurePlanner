...
public class FreeformStatisticsPanel extends JCollapsablePanel implements StatisticsChangeListener {
   private static final int NUMBER_OF_COLUMNS = 4;
   protected StructureModel<FreeformParameters> model;
   private Map<TextureName, JTextField> textureFields;

   public FreeformStatisticsPanel(StructureModel<FreeformParameters> model) {
