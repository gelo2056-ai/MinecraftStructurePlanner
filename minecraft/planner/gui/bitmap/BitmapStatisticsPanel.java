...
public class BitmapStatisticsPanel extends JCollapsablePanel implements StatisticsChangeListener {
   private static final int NUMBER_OF_COLUMNS = 4;
   protected StructureModel<BitmapParameters> model;
   private Map<TextureName, JTextField> textureFields;

   public BitmapStatisticsPanel(StructureModel<BitmapParameters> model) {
