...
public class SlabModelFactory extends ModelFactory {
   ...
   public BlockModel getModel(ModelParameters p) {
      ...
      synchronized (this.boxMap) {
         if (!this.boxMap.containsKey(texture)) {
            ...
            translation.setTranslation(new Vector3f(0.0F, -0.25F, 0.0F));
            transformGroup.setTransform(translation);
            transformGroup.addChild(new Box(0.5F, 0.25F, 0.5F, 67, appearance));
