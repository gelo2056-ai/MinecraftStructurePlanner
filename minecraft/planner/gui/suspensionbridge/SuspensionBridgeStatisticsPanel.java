...
public class SuspensionBridgeStatisticsPanel extends JPanel implements StatisticsChangeListener {
   private static final int NUMBER_OF_COLUMNS = 4;
   protected StructureModel<SuspensionBridgeParameters> model;
   private Map<TextureName, JTextField> textureFields;

   public SuspensionBridgeStatisticsPanel(StructureModel<SuspensionBridgeParameters> model) {
