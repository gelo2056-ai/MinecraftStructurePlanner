...
import minecraft.planner.gui.displaypanels.BitmapPanel.HeightGridPanel.1;
...
public class BitmapPanel<P extends StructureParameters> extends JPanel implements StructureModelChangeListener {
   private static final Color LIGHT_GRAY = new Color(220, 220, 220);
   private static final int SQUARE_SIZE = 30;
   private StructureModel<P> model;
   private BitmapPanel<P>.HeightGridPanel heightGridPanel = new BitmapPanel.HeightGridPanel();
   private JScrollPane scrollPane = new JScrollPane();

   public BitmapPanel(StructureModel<P> model) {
      this.model = model;
   ...
   private class HeightGridPanel extends JPanel {
      ...
      public void paint(Graphics g) {
         super.paint(g);
         WorldGrid grid = BitmapPanel.this.model.getWorldGrid();
      ...
      private void drawSquare(Graphics g, Cell cell) {
         if (cell != null) {
            ...
            if (cell.isProcessed()) {
               ...
               g.setColor(BitmapPanel.LIGHT_GRAY);
            } else {
